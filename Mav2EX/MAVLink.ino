...
void read_mavlink(int maxframes)
{
    ...
    { 
        ...
        if(mavlink_parse_char(MAVLINK_COMM_0, c, msg, &status)) 
        {
            ...
            {
                osd_alt_agl = (mavlink_msg_terrain_report_get_current_height(msg)); // Höhe über Grund aus GPS und BARO
            }
            break;
            ...
            case MAVLINK_MSG_ID_VFR_HUD:
                {
                  //Serial.print("hud:");
                    osd_airspeed = mavlink_msg_vfr_hud_get_airspeed(msg); // in m/s
                    osd_groundspeed = (mavlink_msg_vfr_hud_get_groundspeed(msg))*3.6;
            ...
            #ifdef DEBUG
                    Serial.print(millis());  Serial.print(" : "); Serial.print("osd_airspeed"); Serial.print("  / "); Serial.print(osd_airspeed); Serial.print("  / "); Serial.print("osd_climb"); Serial.print(" / ");
                    Serial.print(osd_climb); Serial.print(" / "); Serial.print("osd_throttle"); Serial.print(" / "); Serial.println(osd_throttle);
            #endif
                }
                break;
