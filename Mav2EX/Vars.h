...
static volatile int16_t        osd_vbat_A = 0;               // Battery A voltage in milivolt
static volatile int16_t        osd_curr_A = 0;               // Battery A current
...
static volatile int16_t        osd_climb = 0;                // Vario
static volatile int32_t        osd_current_consumed;         // Verbrauch in mA
...
static volatile int8_t         osd_fix_type = 0;               // GPS lock 0-1=no fix, 2=2D, 3=3D
...
static volatile int16_t        osd_pitch = 0;                  // pitch from DCM
static volatile int16_t        osd_roll = 0;                   // roll from DCM
static short                   osd_yaw = 0;                    // relative heading form DCM
static volatile int16_t        osd_heading = 0;                // ground course heading from GPS

static volatile int16_t        osd_press_abs = 0;              // Barometrischer Druck
static volatile int16_t        osd_press_alt = 0;              // Barometisscher Höhe in m
...
static volatile int16_t        osd_airspeed = 0;               // airspeed
static volatile int16_t        osd_throttle = 0;               // throttle
